<!--
  ...
  Please use the new task components instead.
-->
<template>
  <div class="task-list">
    ...
    <!-- 任務類型篩選區 -->
    <div class="task-type-filter-section">
      <div class="task-type-filter-label">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
.task-type-filter-label {
  ...
  align-items: center;
  gap: 8px;
  color: rgba(var(--color-teal-rgb), 0.9);
  font-weight: 500;
  font-size: 14px;
  flex-shrink: 0;
}

.task-type-filter-label svg {
...
.task-type-btn:hover:not(.active) {
...
.task-type-btn.active {
  ...
  color: rgba(var(--color-teal-rgb), 1);
}
